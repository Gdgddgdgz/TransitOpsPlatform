      ...
      >
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const region = target.elements.namedItem("region") as HTMLInputElement;
        ...
        >
          ...
          <div className="col-span-2">
            ...
            <input name="region" required className="w-full rounded-lg border border-input bg-secondary/60 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring" placeholder="e.g. West" />
          </div>
